...
func (c *InstancesClient) Get(ctx context.Context, input *GetInstanceInput) (*Instance, error) {
	...
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode get machine response")
	}
...
func (c *InstancesClient) List(ctx context.Context, input *ListInstancesInput) ([]*Instance, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to list machines")
	}

	var results []*_Instance
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&results); err != nil {
		return nil, errors.Wrap(err, "unable to decode list machines response")
	}
...
func (c *InstancesClient) Create(ctx context.Context, input *CreateInstanceInput) (*Instance, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to prepare for machine creation")
	}
	...
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode create machine response")
	}
...
func (c *InstancesClient) Delete(ctx context.Context, input *DeleteInstanceInput) error {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if response == nil {
		return errors.Wrap(err, "unable to delete machine")
	}
	if response.Body != nil {
		defer response.Body.Close()
	}
	...
	if err != nil {
		return errors.Wrap(err, "unable to decode delete machine response")
	}
...
func (c *InstancesClient) DeleteTags(ctx context.Context, input *DeleteTagsInput) error {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return errors.Wrap(err, "unable to delete tags from machine")
	}
	if response == nil {
...
func (c *InstancesClient) DeleteTag(ctx context.Context, input *DeleteTagInput) error {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return errors.Wrap(err, "unable to delete tag from machine")
	}
	if response == nil {
...
func (c *InstancesClient) Rename(ctx context.Context, input *RenameInstanceInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to rename machine")
	}
...
func (c *InstancesClient) ReplaceTags(ctx context.Context, input *ReplaceTagsInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to replace machine tags")
	}
...
func (c *InstancesClient) AddTags(ctx context.Context, input *AddTagsInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to add tags to machine")
	}
...
func (c *InstancesClient) GetTag(ctx context.Context, input *GetTagInput) (string, error) {
	...
	respReader, err := c.client.ExecuteRequest(ctx, reqInputs)
	if err != nil {
		return "", errors.Wrap(err, "unable to get tag")
	}
	if respReader != nil {
		defer respReader.Close()
	}
	...
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return "", errors.Wrap(err, "unable to decode get tag response")
	}
...
func (c *InstancesClient) ListTags(ctx context.Context, input *ListTagsInput) (map[string]interface{}, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to list machine tags")
	}

	var result map[string]interface{}
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable decode list machine tags response")
	}
...
func (c *InstancesClient) GetMetadata(ctx context.Context, input *GetMetadataInput) (string, error) {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return "", errors.Wrap(err, "unable to get machine metadata")
	}
	if response != nil {
		defer response.Body.Close()
	}
	...
	if err != nil {
		return "", errors.Wrap(err, "unable to decode get machine metadata response")
	}
...
func (c *InstancesClient) ListMetadata(ctx context.Context, input *ListMetadataInput) (map[string]string, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to list machine metadata")
	}

	var result map[string]string
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode list machine metadata response")
	}
...
func (c *InstancesClient) UpdateMetadata(ctx context.Context, input *UpdateMetadataInput) (map[string]string, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to update machine metadata")
	}

	var result map[string]string
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode update machine metadata response")
	}
...
func (c *InstancesClient) DeleteMetadata(ctx context.Context, input *DeleteMetadataInput) error {
	...
	respReader, err := c.client.ExecuteRequest(ctx, reqInputs)
	if err != nil {
		return errors.Wrap(err, "unable to delete machine metadata")
	}
	if respReader != nil {
		defer respReader.Close()
	}
...
func (c *InstancesClient) DeleteAllMetadata(ctx context.Context, input *DeleteAllMetadataInput) error {
	...
	respReader, err := c.client.ExecuteRequest(ctx, reqInputs)
	if err != nil {
		return errors.Wrap(err, "unable to delete all machine metadata")
	}
	if respReader != nil {
		defer respReader.Close()
	}
...
func (c *InstancesClient) Resize(ctx context.Context, input *ResizeInstanceInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to resize machine")
	}
...
func (c *InstancesClient) EnableFirewall(ctx context.Context, input *EnableFirewallInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to enable machine firewall")
	}
...
func (c *InstancesClient) DisableFirewall(ctx context.Context, input *DisableFirewallInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to disable machine firewall")
	}
...
func (c *InstancesClient) ListNICs(ctx context.Context, input *ListNICsInput) ([]*NIC, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "unable to list machine NICs")
	}

	var result []*NIC
	decoder := json.NewDecoder(respReader)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode list machine NICs response")
	}
...
func (c *InstancesClient) GetNIC(ctx context.Context, input *GetNICInput) (*NIC, error) {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return nil, errors.Wrap(err, "unable to get machine NIC")
	}
	if response != nil {
		defer response.Body.Close()
	}
	...
	decoder := json.NewDecoder(response.Body)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode get machine NIC response")
	}
...
func (c *InstancesClient) AddNIC(ctx context.Context, input *AddNICInput) (*NIC, error) {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return nil, errors.Wrap(err, "unable to add NIC to machine")
	}
	if response != nil {
		defer response.Body.Close()
	}
	...
	decoder := json.NewDecoder(response.Body)
	if err = decoder.Decode(&result); err != nil {
		return nil, errors.Wrap(err, "unable to decode add NIC to machine response")
	}
...
func (c *InstancesClient) RemoveNIC(ctx context.Context, input *RemoveNICInput) error {
	...
	response, err := c.client.ExecuteRequestRaw(ctx, reqInputs)
	if err != nil {
		return errors.Wrap(err, "unable to remove NIC from machine")
	}
	if response == nil {
		return errors.Wrap(err, "unable to remove NIC from machine")
	}
...
func (c *InstancesClient) Stop(ctx context.Context, input *StopInstanceInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to stop machine")
	}
...
func (c *InstancesClient) Reboot(ctx context.Context, input *RebootInstanceInput) error {
	...
	if err != nil {
		return errors.Wrap(err, "unable to reboot machine")
	}
